              ...
              <div class="st2-info-card">
                ...
                <div class="st2-info-right">
                  <div class="st2-info-details">
                    <div class="st2-info-row" v-if="svcId === 'fullExw' || svcId === 'fullFca'">
                    ...
                    <template v-if="svcId === 'insurance'">
                      <div class="st2-info-row">
                        <div class="st2-info-icon-wrap">💵</div>
                        <span class="st2-info-label">FOB value</span>
                        <span class="st2-info-colon">:</span>
                        <span class="st2-info-value">15,000 USD</span>
                      </div>
                    </template>
                    <template v-if="svcId === 'collectPay'">
                      <div class="st2-info-row">
                        <div class="st2-info-icon-wrap">💰</div>
                        <span class="st2-info-label">Total collection amount</span>
                        <span class="st2-info-colon">:</span>
                        <span class="st2-info-value">25,000 USD</span>
                      </div>
                      <div class="st2-info-row">
                        <div class="st2-info-icon-wrap">💸</div>
                        <span class="st2-info-label">Total payment amount</span>
                        <span class="st2-info-colon">:</span>
                        <span class="st2-info-value">25,000 USD</span>
                      </div>
                    </template>
                    <div class="st2-info-row" v-else>
                      <div class="st2-info-icon-wrap">🏷️</div>
              ...
              <div class="st2-charges-wrap">
                <table class="st2-table">
                  <colgroup>
                    ...
                    <col class="st2-col-unitprice" />
                    <col class="st2-col-qty" />
                  ...
                  <tbody>
                    ...
                    <template v-if="svcId === 'fullExw' || svcId === 'fullFca'">
                      <tr class="st2-tr-section st2-first-section">
                        <td colspan="6">💲 <a>PICK-UP CHARGES</a></td>
                      </tr>
                      <tr class="st2-tr-sub st2-confirmed">
                        <td colspan="6">🔒 Confirmed costs</td>
                      </tr>
                      <tr class="st2-tr-item">
                        <td>Trucking fee</td><td class="td-unit">per Trip</td>
                        <td>200.00</td><td>1</td><td>USD</td><td>200.00</td>
                      </tr>
                      <tr class="st2-tr-subtotal">
                        <td class="blank"></td><td class="blank"></td>
                        <td class="blank"></td><td class="blank"></td><td class="subtotal-lbl" style="text-align: center;">Subtotal</td><td>200.00</td>
                      </tr>
                      <tr class="st2-tr-sub st2-conditional">
                        <td colspan="6">🔴 Conditional costs (if incurred)</td>
                      </tr>
                      <tr class="st2-tr-item">
                        <td>Trucking standby</td><td class="td-unit">per Truck</td>
                        <td>80.00</td><td>1</td><td>USD</td><td>80.00</td>
                      </tr>
                      <tr class="st2-tr-item">
                      ...
                      <tr class="st2-tr-subtotal">
                        <td class="blank"></td><td class="blank"></td>
                        <td class="blank"></td><td class="blank"></td><td class="subtotal-lbl" style="text-align: center;">Subtotal</td><td>160.00</td>
                      </tr>
                    </template>
                    ...
                    <template v-if="svcId === 'fullExw' || svcId === 'customsOnly'">
                      <tr :class="['st2-tr-section', svcId === 'customsOnly' ? 'st2-first-section' : '']">
                        <td colspan="6">💲 <a>CUSTOMS CLEARANCE</a></td>
                      </tr>
                      <tr class="st2-tr-sub st2-confirmed">
                        <td colspan="6">🔒 Confirmed charges</td>
                      </tr>
                      <tr class="st2-tr-item">
                        <td>Customs clearance fee</td>
                        <td class="td-unit">per Set</td>
                        <td>80.00</td><td>1</td><td>USD</td><td>80.00</td>
                      </tr>
                      <tr class="st2-tr-subtotal">
                        <td class="blank"></td><td class="blank"></td>
                        <td class="blank"></td><td class="blank"></td><td class="subtotal-lbl" style="text-align: center;">Subtotal</td><td>80.00</td>
                      </tr>
                      <tr class="st2-tr-sub st2-conditional">
                        <td colspan="6">🔴 Conditional charges (if incurred)</td>
                      </tr>
                      <tr class="st2-tr-item st2-tr-item-dim">
                        <td>Inspection service fee</td>
                        <td class="td-unit">per Set</td>
                        <td>60.00</td><td>1</td><td>USD</td><td>60.00</td>
                      </tr>
                      <tr class="st2-tr-item st2-tr-item-dim">
                        <td>Warehouse fees for inspection</td>
                        <td class="td-unit">per Set</td>
                        <td style="color:#9ca3af;font-style:italic;">As actual</td>
                        <td>1</td>
                        <td style="color:#9ca3af;font-style:italic;">As actual</td>
                        <td style="color:#9ca3af;font-style:italic;">As actual</td>
                      </tr>
                      <tr class="st2-tr-subtotal">
                        <td class="blank"></td><td class="blank"></td>
                        <td class="blank"></td><td class="blank"></td><td class="subtotal-lbl" style="text-align: center;">Subtotal</td><td>60.00++</td>
                      </tr>
                    </template>

                    <!-- ── WAREHOUSE CHARGES (fullExw) ── -->
                    <template v-if="svcId === 'fullExw'">
                      <tr class="st2-tr-section">
                        <td colspan="6">💲 <a>WAREHOUSE CHARGES</a></td>
                      </tr>
                      <tr class="st2-tr-sub st2-confirmed">
                        <td colspan="6">🔒 Confirmed costs</td>
                      </tr>
                      <tr class="st2-tr-item">
                        <td>CFS handling fee</td><td class="td-unit">per Set</td>
                        <td>80.00</td><td>1</td><td>USD</td><td>80.00</td>
                      </tr>
                      <tr class="st2-tr-subtotal">
                        <td class="blank"></td><td class="blank"></td>
                      ...
                      <tr class="st2-tr-item st2-tr-item-dim">
                        <td>Storage fee</td><td class="td-unit">per CBM/day</td>
                        <td style="color:#9ca3af;font-style:italic;">As actual</td>
                        <td>-</td>
                        <td style="color:#9ca3af;font-style:italic;">As actual</td>
                        <td style="color:#9ca3af;font-style:italic;">As actual</td>
                    ...
                    <!-- ── WAREHOUSE CHARGES (fullFca) ── -->
                    <template v-if="svcId === 'fullFca'">
                      <tr class="st2-tr-section">
                        <td colspan="6">💲 <a>WAREHOUSE CHARGES</a></td>
                      </tr>
                      <tr class="st2-tr-sub st2-confirmed">
                      ...
                      <tr class="st2-tr-item">
                        <td>Storage charge</td><td class="td-unit">per Shipment</td>
                        <td>80.00</td><td>1</td><td>USD</td><td>80.00</td>
                      </tr>
                      <tr class="st2-tr-item">
                        <td>Infrastructure fee</td><td class="td-unit">per Ton</td>
                        <td>0.65</td><td>2.5</td><td>USD</td><td>1.63</td>
                      </tr>
                      <tr class="st2-tr-subtotal">
                        <td class="blank"></td><td class="blank"></td>
                        <td class="blank"></td><td class="blank"></td><td class="subtotal-lbl" style="text-align: center;">Subtotal</td><td>81.63</td>
                      </tr>
                      <tr class="st2-tr-sub st2-conditional">
                        <td colspan="6">🔴 Conditional costs (if incurred)</td>
                      </tr>
                    ...
                    <template v-if="svcId === 'collectPay'">
                      <tr class="st2-tr-section st2-first-section">
                        <td colspan="6">💲 <a style="color:#1f2937; text-decoration:underline; text-underline-offset:2px; cursor:pointer;">AGENT HANDLING CHARGES</a></td>
                      </tr>
                      <tr class="st2-tr-sub st2-confirmed">
                        <td colspan="6">🔒 Confirmed charges</td>
                      </tr>
                      <tr class="st2-tr-item">
                        <td>Handling fee</td><td class="td-unit">per Set</td>
                        <td>50.00</td><td>1</td><td>USD</td><td>50.00</td>
                      </tr>
                      <tr class="st2-tr-item">
                        <td>Banking fee</td><td class="td-unit">per Transaction</td>
                        <td>30.00</td><td>1</td><td>USD</td><td>30.00</td>
                      </tr>
                      <tr class="st2-tr-subtotal">
                        <td class="blank"></td><td class="blank"></td>
                        <td class="blank"></td><td class="blank"></td><td class="subtotal-lbl" style="text-align: center;">Subtotal</td>
                        <td>80.00</td>
                      </tr>
                      <tr class="st2-tr-sub st2-conditional">
                        <td colspan="6">🔴 Conditional charges (if incurred)</td>
                    ...
                    <!-- Insurance is per B/L (not per container), so qty cells are 1 -->
                    <template v-if="svcId === 'insurance'">
                      <tr class="st2-tr-section st2-first-section">
                        <td colspan="6">💲 <a>INSURANCE FEE</a></td>
                      </tr>
                      <tr class="st2-tr-sub st2-confirmed">
                        <td colspan="6">🔒 Confirmed charges</td>
                      </tr>
                      <tr class="st2-tr-item">
                        ...
                        <td class="td-unit">per B/L</td>
                        <td style="color:#9ca3af;font-style:italic;">0.1% FOB</td><td>1.00</td><td>USD</td><td>50.00</td>
                      </tr>
                      <tr class="st2-tr-item">
                        <td>Handling fee</td><td class="td-unit">per B/L</td>
                        <td>50.00</td><td>1.00</td><td>USD</td><td>50.00</td>
                      </tr>
                      <tr class="st2-tr-subtotal">
                        <td class="blank"></td><td class="blank"></td>
                        <td class="blank"></td><td class="blank"></td><td class="subtotal-lbl" style="text-align: center;">Subtotal</td><td>100.00</td>
                      </tr>
                      <tr class="st2-tr-sub st2-conditional">
                        <td colspan="6">🔴 Conditional charges (if incurred)</td>
                      </tr>
                  ...
                  <div class="st2-total-amounts">
                    <div class="st2-total-row">
                      ...
                      <span class="st2-t-amount">USD {{ (() => {
                        if (svcId === 'fullExw') return '360.00'
                        if (svcId === 'fullFca') return '281.63'
                        if (svcId === 'customsOnly') return '80.00'
                        if (svcId === 'collectPay') return '80.00'
                        if (svcId === 'insurance') return '100.00'
                        return '0.00'
                      })() }}</span>
                    </div>
                    <div class="st2-total-row">
                      ...
                      <span class="st2-t-amount">USD {{ (() => {
                        if (svcId === 'fullExw') return '220.00++'
                        if (svcId === 'fullFca') return '160.00+'
                        if (svcId === 'customsOnly') return '60.00++'
                        return '—'
                      })() }}</span>
                    </div>
                  </div>
            ...
            <div v-show="(services.origin.selected.length + services.sea.selected.length + services.dest.selected.length) === 1 || activeServiceTab === `sea-${svcId}`" class="summary-full-content">
              ...
              <template v-if="svcId === 'bookingOffered'">
                <div class="st2-info-card">
                  ...
                  <div class="st2-info-right" style="background:#fff;">
                    <div class="st2-info-details">
                      ...
                      <div class="st2-info-row"><div class="st2-info-icon-wrap">📦</div><span class="st2-info-label">Volume</span><span class="st2-info-colon">:</span><span class="st2-info-value">{{ summaryVolume }}</span></div>
                      <div class="st2-info-row"><div class="st2-info-icon-wrap">🏷️</div><span class="st2-info-label">Cargo type</span><span class="st2-info-colon">:</span><span class="st2-info-value">{{ summaryCargoType }}</span></div>
                      <div class="st2-info-row"><div class="st2-info-icon-wrap">⚖️</div><span class="st2-info-label">Cargo weight</span><span class="st2-info-colon">:</span><span class="st2-info-value">{{ cargoWeight }} KGS</span></div>
                      <div class="st2-info-row"><div class="st2-info-icon-wrap">📅</div><span class="st2-info-label">Validity</span><span class="st2-info-colon">:</span><span class="st2-info-value">{{ summaryValidityDate }}</span></div>
                    </div>
                ...
                <div class="st2-charges-wrap" style="background:#fff; margin-top:20px;">
                  ...
                  <div style="padding: 0 20px 20px;" id="schedule-wrap">
<!-- Loop through grouped sailing dates -->
                    <template v-for="group in groupedSailings" :key="group.date">
                      ...
                      <div v-for="(s, idx) in group.list" :key="idx" class="st2-sail-card">
                        ...
                        <!-- Price / sold-out row -->
                        <div :class="s.soldOut ? 'st2-sail-price-row is-sold-out' : 'st2-sail-price-row has-price'" style="align-items:center;">
                          <div style="display:flex; align-items:center; gap:12px; flex-wrap:wrap;">
                            <div class="st2-sail-live-badge"><span class="st2-sail-live-dot"></span> {{ s.spotName }}</div>
                            <button v-if="!s.soldOut" class="st2-breakdown-toggle" :class="{ open: offeredSailingState[group.date + '_' + idx]?.showBreakdown }" @click="toggleOfferedBreakdown(group.date + '_' + idx)">
                          ...
                          <div v-if="!s.soldOut" class="st2-sail-price-tag">
                          ...
                          <div class="st2-sail-btns">
                            <button v-show="false" class="st2-sail-btn st2-cart-btn" :disabled="s.soldOut" :style="s.soldOut ? 'opacity:0.38;cursor:not-allowed;' : ''" @click="addSailingToCart(s, 'offered', offeredCarrierName, group.date + '_' + idx)">🛒 Add cart</button>
                            <button class="st2-sail-btn" :class="offeredSailingState[group.date + '_' + idx]?.selected ? 'st2-selected-active' : 'st2-purchase-active'" :disabled="s.soldOut" :style="s.soldOut ? 'opacity:0.38;cursor:not-allowed;' : ''" @click="toggleOfferedSelect(group.date + '_' + idx)">{{ offeredSailingState[group.date + '_' + idx]?.selected ? '✔ Selected' : '✔ Select' }}</button>
                          </div>
                        </div>

                        <!-- Price breakdown (only for non-sold-out) -->
                        <div v-if="!s.soldOut" v-show="offeredSailingState[group.date + '_' + idx]?.showBreakdown" class="st2-breakdown-body" style="border-top: 1px solid #e2e8f0; border-bottom: none;">
                           <div class="bd-wrap">
                             <div class="bd-head-row bd-grid">
                               <div class="bd-th al">Item</div>
                               <div class="bd-th al">Unit</div>
                               <div class="bd-th ar">Unit price</div>
                               <div class="bd-th ar">Qty</div>
                               <div class="bd-th ac">Currency</div>
                               <div class="bd-th ar">Total price</div>
                             </div>
                             <div class="bd-section">💲 <a>OCEAN FREIGHT</a></div><div class="bd-confirmed">🔒 Confirmed costs</div>
                             <div class="bd-row bd-grid"><div class="bd-td al">Ocean freight charge</div><div class="bd-td al">per W/M</div><div class="bd-td ar">5.00</div><div class="bd-td ar">3.50</div><div class="bd-td ac">USD</div><div class="bd-td ar">17.50</div></div>
                             <div class="bd-row bd-grid"><div class="bd-td al">Fuel surcharge</div><div class="bd-td al">per W/M</div><div class="bd-td ar">3.00</div><div class="bd-td ar">3.50</div><div class="bd-td ac">USD</div><div class="bd-td ar">10.50</div></div>
                             <div class="bd-subtotal-row bd-grid"><div class="bd-td"></div><div class="bd-td"></div><div class="bd-td"></div><div class="bd-td"></div><div class="bd-td ar">Subtotal</div><div class="bd-td ar">28.00</div></div>
                             <div class="bd-conditional">🔴 Conditional costs (if incurred)</div>
                             <div class="bd-row dim bd-grid"><div class="bd-td al">Booking cancellation fee</div><div class="bd-td al">per Set</div><div class="bd-td ar">50.00</div><div class="bd-td ar">1</div><div class="bd-td ac">USD</div><div class="bd-td ar">50.00</div></div>
                             <div class="bd-row dim bd-grid"><div class="bd-td al">Booking amendment fee</div><div class="bd-td al">per Set</div><div class="bd-td ar">25.00</div><div class="bd-td ar">1</div><div class="bd-td ac">USD</div><div class="bd-td ar">25.00</div></div>
                             <div class="bd-row dim bd-grid"><div class="bd-td al">No show fee</div><div class="bd-td al">per Set</div><div class="bd-td ar">50.00</div><div class="bd-td ar">1</div><div class="bd-td ac">USD</div><div class="bd-td ar">50.00</div></div>
                             <div class="bd-subtotal-row bd-grid"><div class="bd-td"></div><div class="bd-td"></div><div class="bd-td"></div><div class="bd-td"></div><div class="bd-td ar">Subtotal</div><div class="bd-td ar">125.00</div></div>
                             <div class="bd-section">💲 <a>ORIGINAL CHARGES</a></div><div class="bd-confirmed">🔒 Confirmed costs</div>
                             <div class="bd-row bd-grid"><div class="bd-td al">Terminal handling charge</div><div class="bd-td al">per W/M</div><div class="bd-td ar">7.00</div><div class="bd-td ar">1</div><div class="bd-td ac">USD</div><div class="bd-td ar">7.00</div></div>
                             <div class="bd-row bd-grid"><div class="bd-td al">Original Document fee</div><div class="bd-td al">per Set</div><div class="bd-td ar">50.00</div><div class="bd-td ar">1</div><div class="bd-td ac">USD</div><div class="bd-td ar">50.00</div></div>
                             <div class="bd-row bd-grid"><div class="bd-td al">Original misc. fee</div><div class="bd-td al">per Set</div><div class="bd-td ar">10.00</div><div class="bd-td ar">1</div><div class="bd-td ac">USD</div><div class="bd-td ar">10.00</div></div>
                             <div class="bd-subtotal-row bd-grid"><div class="bd-td"></div><div class="bd-td"></div><div class="bd-td"></div><div class="bd-td"></div><div class="bd-td ar">Subtotal</div><div class="bd-td ar">67.00</div></div>
                             <div class="bd-conditional">🔴 Conditional costs (if incurred)</div>
                             <div class="bd-row dim bd-grid"><div class="bd-td al">Telex release fee</div><div class="bd-td al">per Set</div><div class="bd-td ar">40.00</div><div class="bd-td ar">1</div><div class="bd-td ac">USD</div><div class="bd-td ar">40.00</div></div>
                             <div class="bd-row dim bd-grid"><div class="bd-td al">Manifest submission fee</div><div class="bd-td al">per Set</div><div class="bd-td ar">35.00</div><div class="bd-td ar">1</div><div class="bd-td ac">USD</div><div class="bd-td ar">35.00</div></div>
                             <div class="bd-subtotal-row bd-grid"><div class="bd-td"></div><div class="bd-td"></div><div class="bd-td"></div><div class="bd-td"></div><div class="bd-td ar">Subtotal</div><div class="bd-td ar">75.00</div></div>
                             <div class="bd-section">💲 <a>DESTINATION CHARGES</a></div><div class="bd-confirmed">🔒 Confirmed costs</div>
                             <div class="bd-row bd-grid"><div class="bd-td al">Terminal handling charge</div><div class="bd-td al">per W/M</div><div class="bd-td ar">8.00</div><div class="bd-td ar">1</div><div class="bd-td ac">USD</div><div class="bd-td ar">8.00</div></div>
                             <div class="bd-row bd-grid"><div class="bd-td al">Destination Document fee</div><div class="bd-td al">per Set</div><div class="bd-td ar">50.00</div><div class="bd-td ar">1</div><div class="bd-td ac">USD</div><div class="bd-td ar">50.00</div></div>
                             <div class="bd-row bd-grid"><div class="bd-td al">Container cleaning fee</div><div class="bd-td al">per W/M</div><div class="bd-td ar">3.00</div><div class="bd-td ar">1</div><div class="bd-td ac">USD</div><div class="bd-td ar">3.00</div></div>
                             <div class="bd-subtotal-row bd-grid"><div class="bd-td"></div><div class="bd-td"></div><div class="bd-td"></div><div class="bd-td"></div><div class="bd-td ar">Subtotal</div><div class="bd-td ar">61.00</div></div>
                             <div class="bd-conditional">🔴 Conditional costs (if incurred)</div>
                           </div>                        </div>
                             ...
                             <div class="st2-route-two-col">
                               ...
                               <div>
                                 ...
                                 <div class="st2-deadlines-box">
                                   ...
                                   <div class="st2-deadline-row"><span class="st2-deadline-label">Cargos Gate-In Deadline</span><span class="st2-deadline-value">{{ s.gateIn }}</span></div>
                      <div class="st2-deadline-row"><span class="st2-deadline-label">Verified Gross Mass Submission Deadline</span><span class="st2-deadline-value">3 days before ETD</span></div>
                      <div class="st2-deadline-row"><span class="st2-deadline-label">Shipping Instructions Submission Deadline</span><span class="st2-deadline-value">2 days before ETD</span></div>
                      <div class="st2-deadline-row"><span class="st2-deadline-label">Shipping Instructions Submission Deadline (Advance Manifest)</span><span class="st2-deadline-value">4 days before ETD</span></div>
                      <div class="st2-deadlines-note">
                        ...
                        Your Shipping Instruction needs to be submitted by the specified deadline, otherwise there is a risk that your cargos will not be loaded on the planned vessel.
                      </div>
                  ...
                  <div v-show="spotCarrierName" style="padding: 0 20px 20px;">
                    ...
                    <template v-for="group in groupedSpotSailings" :key="group.date">
                      ...
                      <div v-for="(s, idx) in group.list" :key="idx" class="st2-sail-card">
                        ...
                        <div :class="s.soldOut ? 'st2-sail-price-row is-sold-out' : 'st2-sail-price-row has-price'" style="align-items:center; background: linear-gradient(90deg, #fff 60%, #f0fdf4 100%);">
                          <div style="display:flex; align-items:center; gap:12px; flex-wrap:wrap;">
                            ...
                            <button v-if="!s.soldOut" class="st2-breakdown-toggle" :class="{ open: spotSailingState[group.date + '_' + idx]?.showBreakdown }" @click="toggleSpotBreakdown(group.date + '_' + idx)">
                              <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="margin-right:2px;"><polyline points="6 9 12 15 18 9"/></svg>
                              Price breakdown &amp; details
                            </button>
                          </div>
                          ...
                          <div class="st2-sail-btns">
                            <button v-show="false" class="st2-sail-btn st2-cart-btn" :disabled="s.soldOut" :style="s.soldOut ? 'opacity:0.38;cursor:not-allowed;' : ''" @click="addSailingToCart(s, 'spot', spotCarrierName, group.date + '_' + idx)">🛒 Add cart</button>
                            <!-- SPOT: amber/yellow Select button -->
                            <button class="st2-sail-btn" :class="spotSailingState[group.date + '_' + idx]?.selected ? 'st2-selected-active' : 'st2-purchase-active'" :disabled="s.soldOut" :style="s.soldOut ? 'opacity:0.38;cursor:not-allowed;' : ''" @click="toggleSpotSelect(group.date + '_' + idx)">{{ spotSailingState[group.date + '_' + idx]?.selected ? '✔ Selected' : '✔ Select' }}</button>
                          </div>
                        </div>

                        <!-- Price breakdown (non-sold-out) -->
                        <div v-if="!s.soldOut" v-show="spotSailingState[group.date + '_' + idx]?.showBreakdown" class="st2-breakdown-body" style="border-top: 1px solid #e2e8f0;">
                  ...
                  <table class="st2-table">
                    ...
                    <thead>
                      <tr>
                        <th>Item</th>
                        <th class="th-unit">Unit</th>
                        <th style="padding: 11px 12px; font-size: 12px; font-weight: 600; color: #6b7280; text-align: right; white-space: nowrap;">Unit price</th>
                        <th style="padding: 11px 12px; font-size: 12px; font-weight: 600; color: #6b7280; text-align: right; white-space: nowrap;">Qty</th>
                        <th style="padding: 11px 12px; font-size: 12px; font-weight: 600; color: #6b7280; text-align: center; white-space: nowrap;">Currency</th>
                        <th>Total price</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr class="st2-tr-section st2-first-section"><td colspan="6">💲 <a style="color:#1f2937; text-decoration:underline; text-underline-offset:2px; cursor:pointer;">AGENT HANDLING CHARGES</a></td></tr>
                      <tr class="st2-tr-sub st2-confirmed"><td colspan="6">🔒 Confirmed costs</td></tr>
                      <tr class="st2-tr-item"><td>Handling fee</td><td class="td-unit">per Set</td><td style="text-align:right;">50.00</td><td style="text-align:right;">1</td><td style="text-align:center;">USD</td><td>50.00</td></tr>
                      <tr class="st2-tr-item"><td>Banking fee</td><td class="td-unit">per Transaction</td><td style="text-align:right;">30.00</td><td style="text-align:right;">1</td><td style="text-align:center;">USD</td><td>30.00</td></tr>
                      <tr class="st2-tr-subtotal"><td class="blank"></td><td class="blank"></td><td class="blank"></td><td class="blank"></td><td class="subtotal-lbl" style="text-align: right; padding-right:12px;">Subtotal</td><td>80.00</td></tr>
                      <tr class="st2-tr-sub st2-conditional"><td colspan="6">🔴 Conditional costs (if incurred)</td></tr>
                    </tbody>
                  </table>
                  <div class="st2-total-footer" style="border-top:2px solid #e5e7eb; padding:16px 18px;">
                    <span class="st2-total-label">TOTAL PRICE</span>
                    <div class="st2-total-amounts">
                      <div class="st2-total-row">
                        <span class="st2-t-tag st2-confirmed">🔒 Confirmed:</span>
                        <span class="st2-t-amount">USD 80.00</span>
                      </div>
                      <div class="st2-total-row">
                        <span class="st2-t-tag st2-conditional">🔴 Conditional:</span>
          ...
          <template v-for="svcId in services.dest.selected" :key="svcId">
            ...
            <div v-show="(services.origin.selected.length + services.sea.selected.length + services.dest.selected.length) === 1 || activeServiceTab === `dest-${svcId}`" class="summary-full-content">
               ...
               <div v-if="svcId === 'dap'">
                   ...
                   <div class="st2-info-left" style="background:#fafafa;">
                     ...
                     <div class="st2-service-card">
                       <div class="st2-svc-top">
                         ...
                         <div class="st2-svc-name" v-html="fmtSvcName('Full DAP service: From import CFS warehouse to consignee\'s door (customs clearance excluded)')"></div>
                       </div>
                       <div class="st2-svc-desc" style="margin-top:6px;">
                         <span class="st2-info-badge">i</span>
                         <span style="font-size:11px;">Shoptrans will be destination agent who helps to handle for import, deliver cargos to consignee's warehouse, but customs clearance is done by consignee.</span>
                       </div>
                     </div>
                   </div>
                   <!-- RIGHT -->
                 ...
                 <!-- Charges Table (LCL 6-column format) -->
                 <div class="st2-charges-wrap" style="background:#fff;margin-top:20px;">
                   <table class="st2-table st2-table-lcl">
                     <colgroup>
                       <col class="st2-col-item" />
                       <col class="st2-col-unit" />
                       <col class="st2-col-unitprice" />
                     ...
                     <tbody>
                       <!-- ARRIVAL CHARGES -->
                       <tr class="st2-tr-section st2-first-section"><td colspan="6">💲 <a>ARRIVAL CHARGES</a></td></tr>
                       <tr class="st2-tr-sub st2-confirmed"><td colspan="6">🔒 Confirmed charges</td></tr>
                       <tr class="st2-tr-item"><td>Terminal handling fee</td><td class="td-unit">per W/M</td><td>7.00</td><td>3.50</td><td>USD</td><td>24.50</td></tr>
                       <tr class="st2-tr-item"><td>Destination document fee</td><td class="td-unit">per Set</td><td>50.00</td><td>1</td><td>USD</td><td>50.00</td></tr>
                       <tr class="st2-tr-subtotal"><td class="blank"></td><td class="blank"></td><td class="blank"></td><td class="blank"></td><td class="subtotal-lbl" style="text-align: center;">Subtotal</td><td>74.50</td></tr>
                       <tr class="st2-tr-sub st2-conditional"><td colspan="6">🔴 Conditional charges (if incurred)</td></tr>
                       <tr class="st2-tr-item"><td class="st2-tr-item-dim-cell">Container cleaning fee</td><td class="st2-tr-item-dim-cell td-unit">per W/M</td><td class="st2-tr-item-dim-cell">3.00</td><td class="st2-tr-item-dim-cell">3.50</td><td class="st2-tr-item-dim-cell">USD</td><td class="st2-tr-item-dim-cell">10.50</td></tr>
                       <tr class="st2-tr-item"><td class="st2-tr-item-dim-cell">Container imbalance fee</td><td class="st2-tr-item-dim-cell td-unit">per W/M</td><td class="st2-tr-item-dim-cell">3.00</td><td class="st2-tr-item-dim-cell">3.50</td><td class="st2-tr-item-dim-cell">USD</td><td class="st2-tr-item-dim-cell">10.50</td></tr>
                       <tr class="st2-tr-subtotal"><td class="blank"></td><td class="blank"></td><td class="blank"></td><td class="blank"></td><td class="subtotal-lbl" style="text-align: center;">Subtotal</td><td>21.00</td></tr>

                       <!-- DELIVERY CHARGES -->
                       <tr class="st2-tr-section"><td colspan="6">💲 <a>DELIVERY CHARGES</a></td></tr>
                       <tr class="st2-tr-sub st2-confirmed"><td colspan="6">🔒 Confirmed charges</td></tr>
                       <tr class="st2-tr-item"><td>Trucking fee</td><td class="td-unit">per Trip</td><td>150.00</td><td>1</td><td>USD</td><td>150.00</td></tr>
                       <tr class="st2-tr-subtotal"><td class="blank"></td><td class="blank"></td><td class="blank"></td><td class="blank"></td><td class="subtotal-lbl" style="text-align: center;">Subtotal</td><td>150.00</td></tr>
                       <tr class="st2-tr-sub st2-conditional"><td colspan="6">🔴 Conditional charges (if incurred)</td></tr>
                       <tr class="st2-tr-item"><td class="st2-tr-item-dim-cell">Trucking standby</td><td class="st2-tr-item-dim-cell td-unit">per Truck</td><td class="st2-tr-item-dim-cell">50.00</td><td class="st2-tr-item-dim-cell">1</td><td class="st2-tr-item-dim-cell">USD</td><td class="st2-tr-item-dim-cell">50.00</td></tr>
                       <tr class="st2-tr-item"><td class="st2-tr-item-dim-cell">Trucking cancellation fee</td><td class="st2-tr-item-dim-cell td-unit">per Truck</td><td class="st2-tr-item-dim-cell">50.00</td><td class="st2-tr-item-dim-cell">1</td><td class="st2-tr-item-dim-cell">USD</td><td class="st2-tr-item-dim-cell">50.00</td></tr>
                       <tr class="st2-tr-subtotal"><td class="blank"></td><td class="blank"></td><td class="blank"></td><td class="blank"></td><td class="subtotal-lbl" style="text-align: center;">Subtotal</td><td>100.00</td></tr>

                       <!-- WAREHOUSE CHARGES -->
                       <tr class="st2-tr-section"><td colspan="6">💲 <a>WAREHOUSE CHARGES</a></td></tr>
                       <tr class="st2-tr-sub st2-confirmed"><td colspan="6">🔒 Confirmed charges</td></tr>
                       <tr class="st2-tr-item"><td>Warehouse fee</td><td class="td-unit">per W/M</td><td>0.65</td><td>3.50</td><td>USD</td><td>2.28</td></tr>
                       <tr class="st2-tr-item"><td>Infrastructure fee</td><td class="td-unit">per Ton</td><td>0.65</td><td>2.50</td><td>USD</td><td>1.63</td></tr>
                       <tr class="st2-tr-subtotal"><td class="blank"></td><td class="blank"></td><td class="blank"></td><td class="blank"></td><td class="subtotal-lbl" style="text-align: center;">Subtotal</td><td>3.91</td></tr>
                       <tr class="st2-tr-sub st2-conditional"><td colspan="6">🔴 Conditional charges (if incurred)</td></tr>
                     </tbody>
                   </table>
                   ...
                   <div class="st2-total-footer" style="border-top:2px solid #e5e7eb;padding:16px 18px;">
                     ...
                     <div class="st2-total-amounts">
                       <div class="st2-total-row">
                         <span class="st2-t-tag st2-confirmed">🔒 Confirmed:</span>
                         <span class="st2-t-amount">USD 228.41</span>
                       </div>
                       <div class="st2-total-row">
                         <span class="st2-t-tag st2-conditional">🔴 Conditional:</span>
                         <span class="st2-t-amount" style="color:#dc2626;">USD 121.00</span>
                       </div>
                     </div>
                   </div>
                 </div>
                 ...
                 <div class="st2-charges-wrap" style="background:#fff;margin-top:20px;">
                   <table class="st2-table st2-table-lcl">
                     ...
                     <tbody>
                       ...
                       <!-- CUSTOMS CLEARANCE -->
                       <tr class="st2-tr-section"><td colspan="6">💲 <a>CUSTOMS CLEARANCE</a></td></tr>
                       <tr class="st2-tr-sub st2-confirmed"><td colspan="6">🔒 Confirmed charges</td></tr>
                       <tr class="st2-tr-item"><td>Customs clearance fee</td><td class="td-unit">per Set</td><td>45.00</td><td>1</td><td>USD</td><td>45.00</td></tr>
                       <tr class="st2-tr-subtotal"><td class="blank"></td><td class="blank"></td><td class="blank"></td><td class="blank"></td><td class="subtotal-lbl" style="text-align: center;">Subtotal</td><td>45.00</td></tr>
                       <tr class="st2-tr-sub st2-conditional"><td colspan="6">🔴 Conditional charges (if incurred)</td></tr>
                       <tr class="st2-tr-item"><td class="st2-tr-item-dim-cell">Inspection service fee</td><td class="st2-tr-item-dim-cell td-unit">per Set</td><td class="st2-tr-item-dim-cell">35.00</td><td class="st2-tr-item-dim-cell">1</td><td class="st2-tr-item-dim-cell">USD</td><td class="st2-tr-item-dim-cell">35.00</td></tr>
                       <tr class="st2-tr-item"><td class="st2-tr-item-dim-cell">Port fees for inspection</td><td class="st2-tr-item-dim-cell td-unit">per Set</td><td class="st2-tr-item-dim-cell na" style="font-style:italic;">As actual</td><td class="st2-tr-item-dim-cell na" style="font-style:italic;">—</td><td class="st2-tr-item-dim-cell na" style="font-style:italic;">—</td><td class="st2-tr-item-dim-cell" style="font-style:italic;">As actual</td></tr>
                       <tr class="st2-tr-subtotal"><td class="blank"></td><td class="blank"></td><td class="blank"></td><td class="blank"></td><td class="subtotal-lbl" style="text-align: center;">Subtotal</td><td>250.00++</td></tr>
                   ...
                   <div class="st2-total-footer" style="border-top:2px solid #e5e7eb;padding:16px 18px;">
                     ...
                     <div class="st2-total-amounts">
                       <div class="st2-total-row">
                         <span class="st2-t-tag st2-confirmed">🔒 Confirmed:</span>
                         <span class="st2-t-amount">USD 273.41</span>
                       </div>
                       <div class="st2-total-row">
                         <span class="st2-t-tag st2-conditional">🔴 Conditional:</span>
                         <span class="st2-t-amount" style="color:#dc2626;">USD 156.00++</span>
                       </div>
                     </div>
                   </div>
                 </div>
                 ...
                 <div class="st2-info-card">
                   ...
                   <div class="st2-info-left" style="background:#fafafa;">
                     ...
                     <div class="st2-service-card">
                       <div class="st2-svc-top">
                         <span class="st2-truck-icon" style="font-size:28px;flex-shrink:0;line-height:1;">🚛</span>
                         <div class="st2-svc-name" v-html="fmtSvcName('Full DDP service: From import CFS warehouse to consignee\'s door (import duty included)')"></div>
                       </div>
                       <div class="st2-svc-desc" style="margin-top:6px;">
                         <span class="st2-info-badge">i</span>
                         <span style="font-size:11px;">Shoptrans will be destination agent who helps to handle for import, deliver cargos to consignee's warehouse. Including customs clearance and import taxes.</span>
                       </div>
                     </div>
                   </div>
                   <!-- RIGHT -->
                 ...
                 <div class="st2-charges-wrap" style="background:#fff;margin-top:20px;">
                   <table class="st2-table st2-table-lcl">
                     ...
                     <tbody>
                       ...
                       <!-- TAXES PAYMENT -->
                       <tr class="st2-tr-section"><td colspan="6">💲 <a>TAXES PAYMENT</a></td></tr>
                       <tr class="st2-tr-sub st2-confirmed"><td colspan="6">🔒 Confirmed charges</td></tr>
                       <tr class="st2-tr-item"><td>Handling fee</td><td class="td-unit">per Transaction</td><td>80.00</td><td>1</td><td>USD</td><td>80.00</td></tr>
                       <tr class="st2-tr-item"><td>Bank fee</td><td class="td-unit">per Transaction</td><td>20.00</td><td>1</td><td>USD</td><td>20.00</td></tr>
                       <tr class="st2-tr-subtotal"><td class="blank"></td><td class="blank"></td><td class="blank"></td><td class="blank"></td><td class="subtotal-lbl" style="text-align: center;">Subtotal</td><td>100.00</td></tr>
                       <tr class="st2-tr-sub st2-conditional"><td colspan="6">🔴 Conditional charges (if incurred)</td></tr>
                     </tbody>
                   </table>
                   ...
                   <div class="st2-total-footer" style="border-top:2px solid #e5e7eb;padding:16px 18px;">
                     ...
                     <div class="st2-total-amounts">
                       <div class="st2-total-row">
                         <span class="st2-t-tag st2-confirmed">🔒 Confirmed:</span>
                         <span class="st2-t-amount">USD 373.41</span>
                       </div>
                       <div class="st2-total-row">
                         <span class="st2-t-tag st2-conditional">🔴 Conditional:</span>
                         <span class="st2-t-amount" style="color:#dc2626;">USD 156.00++</span>
               ...
               <div v-if="svcId === 'customsOnly'">
                 ...
                 <div class="st2-info-card">
                   ...
                   <div class="st2-info-left" style="background:#fafafa;">
                     ...
                     <div class="st2-service-card">
                       ...
                       <div class="st2-svc-desc" style="margin-top:6px;">
                         <span class="st2-info-badge">i</span>
                         <span style="font-size:11px;">Shoptrans works with shipper to complete customs clearance procedures only, other works excluded.</span>
                       </div>
                     </div>
                   </div>
                   <!-- RIGHT -->
                 ...
                 <div class="st2-charges-wrap" style="background:#fff;margin-top:20px;">
                   <table class="st2-table st2-table-lcl">
                     ...
                     <tbody>
                       <tr class="st2-tr-section st2-first-section"><td colspan="6">💲 <a>CUSTOMS CLEARANCE</a></td></tr>
                       <tr class="st2-tr-sub st2-confirmed"><td colspan="6">🔒 Confirmed charges</td></tr>
                       <tr class="st2-tr-item"><td>Customs clearance fee</td><td class="td-unit">per Set</td><td>45.00</td><td>1</td><td>USD</td><td>45.00</td></tr>
                       <tr class="st2-tr-subtotal"><td class="blank"></td><td class="blank"></td><td class="blank"></td><td class="blank"></td><td class="subtotal-lbl" style="text-align: center;">Subtotal</td><td>45.00</td></tr>
                       <tr class="st2-tr-sub st2-conditional"><td colspan="6">🔴 Conditional charges (if incurred)</td></tr>
                       <tr class="st2-tr-item"><td class="st2-tr-item-dim-cell">Inspection service fee</td><td class="st2-tr-item-dim-cell td-unit">per Set</td><td class="st2-tr-item-dim-cell">35.00</td><td class="st2-tr-item-dim-cell">1</td><td class="st2-tr-item-dim-cell">USD</td><td class="st2-tr-item-dim-cell">35.00</td></tr>
                       <tr class="st2-tr-item"><td class="st2-tr-item-dim-cell">Port fees for inspection</td><td class="st2-tr-item-dim-cell td-unit">per Set</td><td class="st2-tr-item-dim-cell na" style="font-style:italic;">As actual</td><td class="st2-tr-item-dim-cell na" style="font-style:italic;">—</td><td class="st2-tr-item-dim-cell na" style="font-style:italic;">—</td><td class="st2-tr-item-dim-cell" style="font-style:italic;">As actual</td></tr>
                       <tr class="st2-tr-subtotal"><td class="blank"></td><td class="blank"></td><td class="blank"></td><td class="blank"></td><td class="subtotal-lbl" style="text-align: center;">Subtotal</td><td>35.00++</td></tr>
                     </tbody>
                   </table>
                   ...
                   <div class="st2-total-footer" style="border-top:2px solid #e5e7eb;padding:16px 18px;">
                     ...
                     <div class="st2-total-amounts">
                       <div class="st2-total-row">
                         <span class="st2-t-tag st2-confirmed">🔒 Confirmed:</span>
                         <span class="st2-t-amount">USD 45.00</span>
                       </div>
                       <div class="st2-total-row">
                         <span class="st2-t-tag st2-conditional">🔴 Conditional:</span>
                         <span class="st2-t-amount" style="color:#dc2626;">USD 35.00++</span>
                       </div>
                     </div>
                   </div>
                 </div>
                       ...
                       <div class="st2-svc-top">
                         <span class="st2-truck-icon" style="flex-shrink:0;line-height:1;display:flex;align-items:center;">
                           <svg width="36" height="36" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg">
                             ...
                             <!-- Lines on invoice --><line x1="10" y1="14" x2="24" y2="14" stroke="#16a34a" stroke-width="1.4" stroke-linecap="round"/><line x1="10" y1="18" x2="24" y2="18" stroke="#d1fae5" stroke-width="1.2" stroke-linecap="round"/><line x1="10" y1="22" x2="20" y2="22" stroke="#d1fae5" stroke-width="1.2" stroke-linecap="round"/>
                             <!-- Dollar sign circle --><circle cx="27" cy="28" r="7" fill="#16a34a"/>
                             <text x="27" y="31.5" text-anchor="middle" font-family="sans-serif" font-size="9" font-weight="800" fill="white">$</text>
                           </svg>
                         </span>
                 ...
                 <div class="st2-charges-wrap" style="background:#fff;margin-top:20px;">
                   <table class="st2-table st2-table-lcl">
                     ...
                     <tbody>
                       ...
                       <tr class="st2-tr-section st2-first-section"><td colspan="6">💲 <a>AGENT HANDLING CHARGES</a></td></tr>
                       <tr class="st2-tr-sub st2-confirmed"><td colspan="6">🔒 Confirmed charges</td></tr>
                       <tr class="st2-tr-item">
                         <td>Handling fee</td>
                         <td class="td-unit">per B/L</td>
                       ...
                       <tr class="st2-tr-item">
                         <td>Banking fee</td>
                         <td class="td-unit">per Transaction</td>
                         <td>25.00</td>
                         <td>1</td>
                         <td>USD</td>
                         <td>25.00</td>
                       ...
                       <tr class="st2-tr-subtotal">
                         ...
                         <td class="blank"></td>
                         <td class="blank"></td>
                         <td class="subtotal-lbl" style="text-align: center;">Subtotal</td>
                         <td>75.00</td>
                       </tr>
                       <tr class="st2-tr-sub st2-conditional"><td colspan="6">🔴 Conditional charges (if incurred)</td></tr>
                     </tbody>
                   ...
                   <div class="st2-total-footer" style="border-top:2px solid #e5e7eb;padding:16px 18px;">
                     ...
                     <div class="st2-total-amounts">
                       <div class="st2-total-row">
                         <span class="st2-t-tag st2-confirmed">🔒 Confirmed:</span>
                         <span class="st2-t-amount">USD 75.00</span>
                       </div>
                     </div>
                   </div>
                 </div>
               ...
               <div v-if="svcId === 'insurance'">
                 ...
                 <div class="st2-info-card">
                   ...
                   <div class="st2-info-left" style="background:#fafafa;">
                     ...
                     <div class="st2-service-card">
                       ...
                       <div class="st2-svc-desc" style="margin-top:6px;">
                         <span class="st2-info-badge">i</span>
                         <span style="font-size:11px;">Shoptrans provides cargo insurance services, works with shipper to buy insurance for the shipment(s).</span>
                       </div>
                     </div>
                   </div>
                   <!-- RIGHT -->
                   <div class="st2-info-right" style="background:#fff;">
                     <div class="st2-info-details">
                       ...
                       <div class="st2-info-row"><div class="st2-info-icon-wrap">🏗️</div><span class="st2-info-label">Port of destination</span><span class="st2-info-colon">:</span><span class="st2-info-value">{{ summaryToPort }}</span></div>
                       <div class="st2-info-row"><div class="st2-info-icon-wrap">📦</div><span class="st2-info-label">Volume</span><span class="st2-info-colon">:</span><span class="st2-info-value">{{ summaryVolume }}</span></div>
                       <div class="st2-info-row"><div class="st2-info-icon-wrap">💵</div><span class="st2-info-label">FOB value</span><span class="st2-info-colon">:</span><span class="st2-info-value">As nominated</span></div>
                       <div class="st2-info-row"><div class="st2-info-icon-wrap">🏷️</div><span class="st2-info-label">Cargo type</span><span class="st2-info-colon">:</span><span class="st2-info-value">{{ summaryCargoType }}</span></div>
                       <div class="st2-info-row"><div class="st2-info-icon-wrap">⏱️</div><span class="st2-info-label">Handling time</span><span class="st2-info-colon">:</span><span class="st2-info-value">2 days</span></div>
                       <div class="st2-info-row"><div class="st2-info-icon-wrap">📅</div><span class="st2-info-label">Validity</span><span class="st2-info-colon">:</span><span class="st2-info-value">{{ summaryValidityDate }}</span></div>
                     </div>
                 ...
                 <div class="st2-charges-wrap" style="background:#fff;margin-top:20px;">
                   <table class="st2-table st2-table-lcl">
                     ...
                     <tbody>
                       <!-- INSURANCE FEE -->
                       <tr class="st2-tr-section st2-first-section"><td colspan="6">💲 <a>INSURANCE FEE</a></td></tr>
                       <tr class="st2-tr-sub st2-confirmed"><td colspan="6">🔒 Confirmed charges</td></tr>
                       <tr class="st2-tr-item">
                         <td>Insurance premium (Min: $50)</td>
                         <td class="td-unit">per B/L</td>
                         <td style="font-style:italic; color:#9ca3af;">0.1% FOB</td>
                         <td>1</td>
                         <td>USD</td>
                         <td>50.00</td>
                       </tr>
                  ...
                  <div class="st2-charges-wrap" style="background:#fff;margin-top:20px;">
                    <table class="st2-table st2-table-lcl">
                      ...
                      <tbody>
                        ...
                        <tr class="st2-tr-section st2-first-section"><td colspan="6">💲 <a>ARRIVAL CHARGES</a></td></tr>
                        <tr class="st2-tr-sub st2-confirmed"><td colspan="6">🔒 Confirmed charges</td></tr>
                        <tr class="st2-tr-item"><td>Terminal Handling Charge</td><td class="td-unit">per W/M</td><td>7.00</td><td>3.50</td><td>USD</td><td>24.50</td></tr>
                        <tr class="st2-tr-item"><td>Delivery Order Fee</td><td class="td-unit">per B/L</td><td>40.00</td><td>1.00</td><td>USD</td><td>40.00</td></tr>
                        <tr class="st2-tr-item"><td>Container Imbalance Charge</td><td class="td-unit">per W/M</td><td>5.00</td><td>3.50</td><td>USD</td><td>17.50</td></tr>
                        <tr class="st2-tr-item"><td>Container Cleaning Charge</td><td class="td-unit">per W/M</td><td>3.00</td><td>3.50</td><td>USD</td><td>10.50</td></tr>
                        <tr class="st2-tr-item"><td>Container Maintenance Charge</td><td class="td-unit">per W/M</td><td>3.00</td><td>3.50</td><td>USD</td><td>10.50</td></tr>
                        <tr class="st2-tr-subtotal">
                          <td class="blank"></td><td class="blank"></td><td class="blank"></td><td class="blank"></td>
                          <td class="subtotal-lbl" style="text-align: center;">Subtotal</td><td>103.00</td>
                        </tr>
                        <tr class="st2-tr-sub st2-conditional"><td colspan="6">🔴 Conditional charges (if incurred)</td></tr>
                        
                        <!-- AGENT HANDLING CHARGES -->
                        <tr class="st2-tr-section"><td colspan="6">💲 <a>AGENT HANDLING CHARGES</a></td></tr>
                        <tr class="st2-tr-sub st2-confirmed"><td colspan="6">🔒 Confirmed charges</td></tr>
                        <tr class="st2-tr-item"><td>Agent Handling Fee</td><td class="td-unit">per B/L</td><td>75.00</td><td>1.00</td><td>USD</td><td>75.00</td></tr>
                        <tr class="st2-tr-subtotal">
                          <td class="blank"></td><td class="blank"></td><td class="blank"></td><td class="blank"></td>
                          <td class="subtotal-lbl" style="text-align: center;">Subtotal</td><td>75.00</td>
                        </tr>
                        <tr class="st2-tr-sub st2-conditional"><td colspan="6">🔴 Conditional charges (if incurred)</td></tr>
                      </tbody>
                    </table>
                    ...
                    <div class="st2-total-footer" style="border-top:2px solid #e5e7eb;padding:16px 18px;">
                      ...
                      <div class="st2-total-amounts">
                        <div class="st2-total-row">
                          <span class="st2-t-tag st2-confirmed">🔒 Confirmed:</span>
                          <span class="st2-t-amount">USD 178.00</span>
                        </div>
                        <div class="st2-total-row">
                          <span class="st2-t-tag st2-conditional">🔴 Conditional:</span>
                          <span class="st2-t-amount">USD —</span>
...
const activeServiceTab = inject('lcl-activeServiceTab') as Ref<string>
const allServiceTabs = inject('lcl-allServiceTabs') as ComputedRef<any[]>
const orderedOriginServices = inject('lcl-orderedOriginServices') as ComputedRef<string[]>
const orderedSeaServices = inject('lcl-orderedSeaServices') as ComputedRef<string[]>
const orderedDestServices = inject('lcl-orderedDestServices') as ComputedRef<string[]>
const fmtSvcName = inject('lcl-fmtSvcName') as (s: string) => string
const getServiceName = inject('lcl-getServiceName') as (id: string) => string
const getServiceCostSummary = inject('lcl-getServiceCostSummary') as (id: string) => any
const originExpandedState = inject('lcl-originExpandedState') as any
const seaExpandedState = inject('lcl-seaExpandedState') as any
const destExpandedState = inject('lcl-destExpandedState') as any
const isSeaExpanded = inject('lcl-isSeaExpanded') as Ref<boolean>
const toggleOriginExpand = inject('lcl-toggleOriginExpand') as (id: string) => void
const toggleSeaExpand = inject('lcl-toggleSeaExpand') as (id: string) => void
const toggleDestExpand = inject('lcl-toggleDestExpand') as (id: string) => void
const tableShow20 = inject('lcl-tableShow20') as ComputedRef<boolean>
const tableShow40 = inject('lcl-tableShow40') as ComputedRef<boolean>
const tableShow45 = inject('lcl-tableShow45') as ComputedRef<boolean>
const tableActiveCols = inject('lcl-tableActiveCols') as ComputedRef<number>
const tableQty20 = inject('lcl-tableQty20') as ComputedRef<number>
const tableQty40 = inject('lcl-tableQty40') as ComputedRef<number>
const tableQty45 = inject('lcl-tableQty45') as ComputedRef<number>
const openServiceDetails = inject('lcl-openServiceDetails') as (type: string, id: string) => void
const removeService = inject('lcl-removeService') as (type: string, id: string) => void
const handleBack = inject('lcl-handleBack') as () => void
const handleAddToCart = inject('lcl-handleAddToCart') as () => void
const openPurchaseForm = inject('lcl-openPurchaseForm') as () => void
const showSpotPriceBreakdown = inject('lcl-showSpotPriceBreakdown') as Ref<boolean>
const offeredSailingState = inject('lcl-offeredSailingState') as any
const toggleOfferedRoute = inject('lcl-toggleOfferedRoute') as (key: string) => void
const toggleOfferedBreakdown = inject('lcl-toggleOfferedBreakdown') as (key: string) => void
const toggleOfferedSelect = inject('lcl-toggleOfferedSelect') as (key: string) => void
const offeredCarrierName = inject('lcl-offeredCarrierName') as Ref<string>
const groupedSailings = inject('lcl-groupedSailings') as ComputedRef<any[]>
const selectedCarrierSchedule = inject('lcl-selectedCarrierSchedule') as ComputedRef<any>
const spotCarrierName = inject('lcl-spotCarrierName') as Ref<string>
const groupedSpotSailings = inject('lcl-groupedSpotSailings') as ComputedRef<any[]>
const spotCarrierSchedule = inject('lcl-spotCarrierSchedule') as ComputedRef<any>
const cargoWeight = inject('lcl-cargoWeight') as Ref<string>
const addSailingToCart = inject('lcl-addSailingToCart') as (sailing: any, rateType: string, carrierName: string, sailingKey: string) => void
const spotSailingState = inject('lcl-spotSailingState') as any
const toggleSpotRoute = inject('lcl-toggleSpotRoute') as (key: string) => void
const toggleSpotBreakdown = inject('lcl-toggleSpotBreakdown') as (key: string) => void
const toggleSpotSelect = inject('lcl-toggleSpotSelect') as (key: string) => void
const changeOptionGoToStep2 = inject('lcl-changeOptionGoToStep2') as () => void
const showDlDropdown = inject('lcl-showDlDropdown') as Ref<boolean>
const downloadDropdownRef = inject('lcl-downloadDropdownRef') as Ref<any>
const downloadCurrentService = inject('lcl-downloadCurrentService') as () => void
const downloadAllServices = inject('lcl-downloadAllServices') as () => void
const selectedContainerType = inject('lcl-selectedContainerType') as Ref<string>

// Summary helper functions & computed values
const tblCell = inject('lcl-tblCell') as (unitPrice: number, qty: number, show: boolean) => string
const tblTotal = inject('lcl-tblTotal') as (rates: { s20?: number; s40?: number; s45?: number }) => string
const summaryFromPort = inject('lcl-summaryFromPort') as ComputedRef<string>
const summaryToPort = inject('lcl-summaryToPort') as ComputedRef<string>
const summaryOriginCountry = inject('lcl-summaryOriginCountry') as ComputedRef<string>
const summaryDestCountry = inject('lcl-summaryDestCountry') as ComputedRef<string>
const summaryValidityDate = inject('lcl-summaryValidityDate') as ComputedRef<string>
const originFlagImage = inject('lcl-originFlagImage') as ComputedRef<string>
const destFlagImage = inject('lcl-destFlagImage') as ComputedRef<string>
const selectedCommodity = inject('lcl-selectedCommodity') as Ref<any>
const computedFixedTotal = inject('lcl-computedFixedTotal') as ComputedRef<string>
const computedPotentialTotal = inject('lcl-computedPotentialTotal') as ComputedRef<string>
const summaryPickupLocation = inject('lcl-summaryPickupLocation') as ComputedRef<string>
const summaryPortOfLoading = inject('lcl-summaryPortOfLoading') as ComputedRef<string>
const summaryPortOfDestination = inject('lcl-summaryPortOfDestination') as ComputedRef<string>
const summaryVolume = inject('lcl-summaryVolume') as ComputedRef<string>
const summaryCargoType = inject('lcl-summaryCargoType') as ComputedRef<string>
const summaryDeliveryLocation = inject('lcl-summaryDeliveryLocation') as ComputedRef<string>
const selectedCarrier = inject('lcl-selectedCarrier') as Ref<any>
const selectedCarrierForSummary = inject('lcl-selectedCarrierForSummary') as any
const detailedForm = inject('lcl-detailedForm') as any
const detailedFormDdp = inject('lcl-detailedFormDdp') as any
const detailedFormDap = inject('lcl-detailedFormDap') as any
const detailedFormDdu = inject('lcl-detailedFormDdu') as any
const detailedFormAvailable = inject('lcl-availableBooking') as any
const detailedFormContract = inject('lcl-contractBooking') as any
const selectedCarrierName = inject('lcl-selectedCarrierName') as ComputedRef<string>

// Image imports
const img_109 = inject('lcl-img_109') as string
const img_110 = inject('lcl-img_110') as string
const carriertemp = inject('lcl-carriertemp') as string
const iconOrigin = inject('lcl-iconOrigin') as string
const iconSea = inject('lcl-iconSea') as string
const iconDest = inject('lcl-iconDest') as string
const goBackImg = inject('lcl-goBackImg') as string
const cartIcon = inject('lcl-cartIcon') as string
const purchaseBtnIcon = inject('lcl-purchaseBtnIcon') as string
const iconPickup = inject('lcl-iconPickup') as string
const iconPortLoading = inject('lcl-iconPortLoading') as string
const iconPortDestination = inject('lcl-iconPortDestination') as string
const iconVolume = inject('lcl-iconVolume') as string
const iconCargoType = inject('lcl-iconCargoType') as string
const iconValidity = inject('lcl-iconValidity') as string
const img_23 = inject('lcl-img_23') as string
const img_20 = inject('lcl-img_20') as string
const ship4png = inject('lcl-ship4png') as string
</script>
...
/* ── Price breakdown — CSS Grid (header + rows share identical columns) ── */
.bd-wrap { font-size: 12px; }
.bd-grid {
  display: grid;
  grid-template-columns: 2fr 1fr 1fr 1fr 1fr 1fr;
}
.bd-head-row { background: #fafafa; border-bottom: 2px solid #e5e7eb; }
.bd-th {
  padding: 10px 12px; font-size: 12px; font-weight: 600;
  color: #6b7280; white-space: nowrap;
}
.bd-section {
  padding: 10px 12px 4px; font-size: 12px; font-weight: 800;
  letter-spacing: 0.06em; text-transform: uppercase; color: #1f2937;
  border-top: 2px solid #e5e7eb;
}
.bd-section a { color: #1f2937; text-decoration: underline; text-underline-offset: 2px; cursor: pointer; }
.bd-confirmed { padding: 5px 12px; font-size: 12px; font-weight: 700; color: #15803d; background: #f0fdf4; border-top: 1px solid #bbf7d0; border-bottom: 1px solid #bbf7d0; }
.bd-conditional { padding: 5px 12px; font-size: 12px; font-weight: 700; color: #dc2626; background: #fff5f5; border-top: 1px solid #fecaca; border-bottom: 1px solid #fecaca; }
.bd-row { border-bottom: 1px solid #f3f4f6; }
.bd-row.dim .bd-td { color: #9ca3af; }
.bd-td {
  padding: 8px 12px; font-size: 13px; color: #1f2937;
}
.bd-subtotal-row { background: #f9fafb; border-top: 1px solid #e5e7eb; border-bottom: 1px solid #e5e7eb; }
.bd-subtotal-row .bd-td { font-size: 13px; font-weight: 700; }
.al { text-align: left; }
.ar { text-align: right; }
