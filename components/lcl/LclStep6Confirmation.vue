      ...
      <div class="s6-wrap">
        <div class="s6-container">
          ...
          <div class="s6-actions">
            ...
            <div class="s6-action-item" @click="$router.push('/fcl')">
            ...
            <div class="s6-action-item" @click="reloadLcl">
              <div class="s6-icon-wrap">
...
const bookingReference = inject('lcl-bookingReference') as Ref<string>

const reloadLcl = () => {
  window.location.href = '/lcl'
}
</script>
